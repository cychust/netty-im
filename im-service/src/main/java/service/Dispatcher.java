    ...
    public static void dispatch(MessageHolder messageHolder) {
        ...
        switch (messageHolder.getType()) {
            ...
            case ProtocolHeader.ALL_FRIEND:
                MyFriends myFriend = Serializer.deserialize(messageHolder.getBody(), MyFriends.class);
            ...
            case ProtocolHeader.LOOK_GROUP_INFO:
                MyGroups myGroup = Serializer.deserialize(messageHolder.getBody(), MyGroups.class);
